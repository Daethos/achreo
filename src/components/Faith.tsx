...
export const FAITHS = [{
    name: 'Ancients',
    origin: "The Ancients were figures of fantastic might existing before historical recording of time, commanding worshipers of all peoples of this world. These godlike beings interacted with humans at their leisure, whether distantly ala Achreo of the Wild, or heavily involved in the daily lives of their worshipersers, such as Ilios of the Sun, and Ma'anre of the Moon. Some time a thousand years past, a great war between the Ancients--heavily involving humans, broke out and wiped out the majority of both. It's unknown at this time who remains, and in what form they may be existing.",
