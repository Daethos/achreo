...
export default function GraceModal({ setShow, settings }: { setShow: Setter<boolean>; settings: Accessor<Settings>; }) {
    ...
    return <div class="border superCenter borderTalent" style={{ width: "50%", "border-color": "blue", "box-shadow": "inset #000 0 0 0 0.2em, inset blue 0 0 0 0.3em", "--base-shadow":"#000 0 0 0 0.2em", "--glow-color":"blue" }} onClick={() => setShow(false)}> 
