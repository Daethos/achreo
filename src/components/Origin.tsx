...
const ORIGINS = [{
    ...
    index: 'ashtre',
    bonus: '+2 STR, +2 AGI, +5% Crit, +5% Crit Dam, +5% Phys Dam, +5% Stamina',
    ...
    index: 'fyers',
    bonus: '+2 ACH, +2 KYO, +5% Mag Pen, +5% Phys Pen, +5% Roll', // +10% Grace (Special Ability Stamina)
    ...
    index: "li'ivi",
    bonus: '+1 STR, +2 AGI, +1 ACH, +2 CAER, +1 KYO, +2% Crit, +2% Crit Dam, +2% Roll, +2% Phys Dam, +2% Mag Dam, +2% Mag Pen, +2% Phys Pen, +5% Stamina',
    ...
    index: "noth'eo",
    bonus: '+2 CON, +2 ACH, +5% Phys Dam, +5% Phys Pen, +5% Mag Def',
    ...
    index: "noth'os",
    bonus: '+2 CON, +2 CAER, +5% Mag Dam, +5% Mag Pen, +5% Phys Def',
