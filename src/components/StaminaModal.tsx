export default function StaminaModal() {
    return <div class="border superCenter" style={{ width: '50%', 'border-color': 'green' }}> 
        <div class='creature-heading wrap' style={{ height: '100%' }}>
            ...
            <svg height="5" width="100%" class="tapered-rule" style={{ 'margin-bottom': '3%', 'margin-top': '2%', 'fill': '', 'stroke': 'green' }}>
                <polyline points="0,0 400,2.5 0,5"></polyline>
            </svg>
            <div class='center'>
                <h2>Your body and mind's capacity to continue. An amalgamation of your Constitution, Strength, and Agility. Governs the ability to perform a physical or special action.</h2>
