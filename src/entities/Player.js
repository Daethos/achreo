...
export default class Player extends Entity {
    ...
    playerDodge = () => {
        ...
        const dodgeLoop = (timestamp) => {
            ...
            const direction = this.flipX ? -(PLAYER.DODGE.DISTANCE / PLAYER.DODGE.DURATION) : (PLAYER.DODGE.DISTANCE / PLAYER.DODGE.DURATION);
            if (Math.abs(this.velocity.x) > 0) this.setVelocityX(direction);
            if (this.velocity.y > 0) this.setVelocityY(PLAYER.DODGE.DISTANCE / PLAYER.DODGE.DURATION);
            if (this.velocity.y < 0) this.setVelocityY(-PLAYER.DODGE.DISTANCE / PLAYER.DODGE.DURATION);
            currentDistance += Math.abs(PLAYER.DODGE.DISTANCE / PLAYER.DODGE.DURATION);
    ...
    playerRoll = () => {
        ...
        const rollLoop = (timestamp) => {
            ...
            const direction = this.flipX ? -(PLAYER.ROLL.DISTANCE / PLAYER.ROLL.DURATION) : (PLAYER.ROLL.DISTANCE / PLAYER.ROLL.DURATION);
            if (Math.abs(this.velocity.x) > 0.1) this.setVelocityX(direction);
            if (this.velocity.y > 0) this.setVelocityY(PLAYER.ROLL.DISTANCE / PLAYER.ROLL.DURATION);
            if (this.velocity.y < 0) this.setVelocityY(-PLAYER.ROLL.DISTANCE / PLAYER.ROLL.DURATION);
            currentDistance += Math.abs(PLAYER.ROLL.DISTANCE / PLAYER.ROLL.DURATION);
