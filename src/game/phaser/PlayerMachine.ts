...
export default class PlayerMachine {
    ...
    onAttackEnter = () => {
        ...
        if (this.player.isRanged === true && this.player.inCombat === true) {
            ...
            if (!correct) {
                this.player.resistCombatText = new ScrollingCombatText(this.scene, this.player.x, this.player.y, 'Skill Issue: Look at the Enemy!', 1000, 'damage', false, true);
                return;
            };
        };
    ...
    onParryEnter = () => {
        ...
        if (this.player.hasMagic === true) {
            this.player.specialCombatText = new ScrollingCombatText(this.scene, this.player.x, this.player.y, 'Counter Spell', 1000, 'hush');
    ...
    onPostureEnter = () => {
        ...
        if (this.player.isRanged === true) {
            if (this.player.isMoving === true) {
                this.player.resistCombatText = new ScrollingCombatText(this.scene, this.player.x, this.player.y, 'Posture Issue: You are Moving', 1000, 'damage', false, true);
                return;
            };
            const correct = this.player.getEnemyDirection(this.player.currentTarget);
    ...
    onDevourEnter = () => {
        ...
        this.player.specialCombatText = new ScrollingCombatText(this.scene, this.player.x, this.player.y, 'Devouring', PLAYER.DURATIONS.DEVOUR / 2, 'damage');
    ...
    onIlirechEnter = () => {
        if (this.player.currentTarget === undefined || this.player.outOfRange(PLAYER.RANGE.MODERATE) || this.player.invalidTarget(this.player.currentTarget?.enemyID)) return;
        this.player.spellTarget = this.player.currentTarget.enemyID;
        this.player.specialCombatText = new ScrollingCombatText(this.scene, this.player.x, this.player.y, 'Ilirech', PLAYER.DURATIONS.ILIRECH / 2, 'cast');
    ...
    onInvokeExit = () => {
        this.player.setStatic(false);
        if (!this.player.currentTarget || this.player.currentTarget.isDefeated) return;
    ...
    onMaierethEnter = () => {
        if (this.player.currentTarget === undefined || this.player.outOfRange(PLAYER.RANGE.MODERATE) || this.player.invalidTarget(this.player.currentTarget.enemyID)) return;
        this.player.spellTarget = this.player.currentTarget.enemyID;
        this.player.specialCombatText = new ScrollingCombatText(this.scene, this.player.x, this.player.y, 'Maiereth', 750, 'effect');
    ...
    onRecallEnter = () => {
        this.player.setStatic(true);
        this.player.isPraying = true;
        this.player.specialCombatText = new ScrollingCombatText(this.scene, this.player.x, this.player.y, 'Recalling', DURATION.TEXT, 'effect', false, true);
        this.player.flickerCarenic(1000);
        if (this.scene.settings.desktop === false) {
            this.scene.joystick.joystick.setVisible(false);
            this.scene.rightJoystick.joystick.setVisible(false);
    ...
    onQuorEnter = () => {
        this.player.specialCombatText = new ScrollingCombatText(this.scene, this.player.x, this.player.y, 'Quor', PLAYER.DURATIONS.QUOR / 2, 'cast');
    ...
    absorb = () => {
        this.scene.sound.play('absorb', { volume: this.scene.settings.volume });
        this.player.specialCombatText = new ScrollingCombatText(this.scene, this.player.x, this.player.y, 'Abosrbed', 500, 'effect');
    ...
    onMenaceEnter = () => {
        ...
        this.player.specialCombatText = new ScrollingCombatText(this.scene, this.player.x, this.player.y, 'Menacing', 750, 'tendril');
    ...
    onModerateEnter = () => {
        ...
        this.player.specialCombatText = new ScrollingCombatText(this.scene, this.player.x, this.player.y, 'Moderating', 750, 'cast');
    ...
    multifarious = (id: string) => {
        ...
        this.scene.sound.play('combat-round', { volume: this.scene.settings.volume });
        this.player.specialCombatText = new ScrollingCombatText(this.scene, this.player.x, this.player.y, 'Multifarious', 500, 'cast');
        this.player.reactiveBubble.setCharges(this.player.reactiveBubble.charges - 1);
        if (this.player.reactiveBubble.charges <= 3) {
            this.player.isMultifaring = false;
        };
    ...
    onMystifyEnter = () => {
        ...
        this.player.specialCombatText = new ScrollingCombatText(this.scene, this.player.x, this.player.y, 'Mystifying', 750, 'effect');
    ...
    mystify = (id: string) => {
        ...
        this.scene.sound.play('death', { volume: this.scene.settings.volume });
        this.player.specialCombatText = new ScrollingCombatText(this.scene, this.player.x, this.player.y, 'Mystifying', 500, 'effect');
        this.player.reactiveBubble.setCharges(this.player.reactiveBubble.charges - 1);
        if (this.player.reactiveBubble.charges <= 3) {
            this.player.isMystifying = false;
        };
    ...
    onReinEnter = () => {
        ...
        this.scene.sound.play(States.ABSORB, { volume: this.scene.settings.volume });
        this.player.specialCombatText = new ScrollingCombatText(this.scene, this.player.x, this.player.y, 'Rein', 750, 'effect');
    ...
    rein = () => {
        this.scene.sound.play('absorb', { volume: this.scene.settings.volume });
        this.player.specialCombatText = new ScrollingCombatText(this.scene, this.player.x, this.player.y, 'Reining', 500, 'effect');
        this.scene.combatManager.useGrace(-25);
    };
    ...
    shimmer = () => {
        ...
        this.scene.sound.play('stealth', { volume: this.scene.settings.volume });
        this.player.specialCombatText = new ScrollingCombatText(this.scene, this.player.x, this.player.y, shim, 1500, 'effect');
    };
        ...
        this.player.confuseTimer = this.scene.time.addEvent({
            ...
            callback: () => {
                ...
                if (iteration === 6) {
                    ...
                    randomDirection();
                    this.player.specialCombatText = new ScrollingCombatText(this.scene, this.player.x, this.player.y, confusions[Math.floor(Math.random() * 5)], 750, 'effect');
                };
            },
            callbackScope: this,
            repeat: 6,
        ...
        this.player.fearTimer = this.scene.time.addEvent({
            ...
            callback: () => {
                ...
                if (iteration === 4) {
                    ...
                    randomDirection();
                    this.player.specialCombatText = new ScrollingCombatText(this.scene, this.player.x, this.player.y, fears[Math.floor(Math.random() * 5)], 750, 'damage');
                };
            },
            callbackScope: this,
            repeat: 4,
    ...
    onFrozenEnter = () => {
        this.player.specialCombatText = new ScrollingCombatText(this.scene, this.player.x, this.player.y, 'Frozen', DURATION.TEXT, 'cast', false, true);
    ...
    onSlowedEnter = () => {
        this.player.specialCombatText = new ScrollingCombatText(this.scene, this.player.x, this.player.y, 'Slowed', DURATION.TEXT, 'effect', false, true);
    ...
    onSnaredEnter = () => {
        this.player.specialCombatText = new ScrollingCombatText(this.scene, this.player.x, this.player.y, 'Snared', DURATION.TEXT, 'effect', false, true);
