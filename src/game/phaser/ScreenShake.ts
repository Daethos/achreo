var totalTrauma = 0;
export function screenShake(scene: Phaser.Scene, duration = 40, intensity = 0.003) {
    totalTrauma += 1.03;
...
export function sprint(scene: Phaser.Scene, duration = 40, intensity = 0.00125) { // 48 || 0.0004
    scene.cameras.main.shake(duration, intensity);
};
