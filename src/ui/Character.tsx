...
const SPECIAL = {
    'constitution': ['Consume', 'Desperation', 'Disease', 'Healing', 'Invoke', 'Mend', 'Renewal', 'Sacrifice', 'Shield', 'Ward'], // 10
    'strength': ['Arc', 'Consume', 'Howl', 'Invoke', 'Leap', 'Recover', 'Scream', 'Storm', 'Suture', 'Tshaeral', 'Ward', 'Writhe'], // 12
    'agility': ['Consume', 'Desperation', 'Envelop', 'Invoke', 'Pursuit', 'Recover', 'Rush', 'Shimmer', 'Snare', 'Sprint', 'Storm', 'Writhe'], // 12
    'achre': ['Blink', 'Confuse', 'Consume', 'Envelop', 'Freeze', 'Invoke', 'Polymorph', 'Recover', 'Root', 'Sacrifice', 'Shimmer', 'Slow'], // 12
    'caeren': ['Chiomism', 'Consume', 'Desperation', 'Fear', 'Healing', 'Invoke', 'Mend', 'Protect', 'Sacrifice', 'Shield', 'Suture'], // 12
    'kyosir': ['Chiomic', 'Chiomism', 'Confuse', 'Consume', 'Invoke', 'Malice', 'Protect', 'Scream', 'Suture', 'Tshaeral'], // 10
};
