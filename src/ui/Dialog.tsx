// import React, { createSignal, createEffect, Setter } from 'solid-js'
...
//     const [showDialogOptions, setShowDialogOptions] = createSignal(false);
...
//         return (
//             <div key={i}>
//                 <button class='highlight dialog-buttons' className='dialog-buttons' onClick={() => setIntent(o)} style={{ color: 'green', fontVariant: 'small-caps', fontWeight: 550 }}>{o}</button>
//             </div>
//         );
//     });
//     return <>{buttons}</>;
...
//         EventBus.emit('aggressive-enemy', { id: state.enemyID, isAggressive: true });
...
//                     return (
//                         <div key={index}>
//                             <button class='highlight dialog-buttons' style={{ color: traitStyle(trait.name), fontSize: "18px" }} onClick={() => attemptLuckout(trait.name)}>[{trait.name}] - {trait.luckout.modal.replace('{enemy.name}', state?.computer?.name).replace('{ascean.weapon_one.influences[0]}', influence)}</button>
//                         </div>
//                     )
//                 })}
//                 </div>
...
//                     return (
//                         <div key={index}>
//                             <button class='highlight dialog-buttons' style={{ color: traitStyle(trait.name), fontSize: "18px" }} onClick={() => attemptPersuasion(trait.name)}>[{trait.name}]: {trait.persuasion.modal.replace('{enemy.name}', state?.computer?.name).replace('{ascean.weapon_one.influences[0]}', influence)}</button>
//                         </div>
//                     )
//                 })}
//                 </div>
...
//                                     <br />
//                                     <button class='highlight dialog-buttons' style={{ color: 'red' }} onClick={engageCombat}>Forego pleasantries and surprise attack {state?.computer?.name}?</button>
//                                 </> 
//                             ) : ( 
//                                 <>
...
//                                     <br />
//                                     <button class='highlight dialog-buttons' style={{ color: 'red' }} onClick={engageCombat}>Engage in hostilities with {state?.computer?.name}?</button>
//                                 </> 
//                             ) }
//                             { luckout ? ( 
...
//                                         <div key={index}>
//                                             {trait.name === "Se'van" ? (
//                                                 <button class='highlight dialog-buttons' onClick={() => engageGrappling()}>[Testing] Surprise {state?.computer?.name} and initiate Se'van Grappling</button>
//                                             ) : trait.name === "Cambiren" ? (
...
//                             <button class='highlight dialog-buttons' onClick={() => clearDuel()}>You remain at the edges of sight and sound, and before {state?.computer?.name} can react, you attempt to flee.</button>
//                         ) : ( '' ) }
//                     </>
