...
export default function GraceBubble({ grace, show, setShow, settings }: {grace:Accessor<number>; show:Accessor<boolean>; setShow:Setter<boolean>; settings: Accessor<Settings>;}) {
    ...
    return <div class="graceBubble" onClick={() => setShow(!show())}>
        ...
        <p class="grace" style={{ "color": "#fdf6d8","font-weight": "bold", "text-shadow": "0.1em 0.1em 0.1em #000",animation: "flicker 1s ease", "--glow-color": "#fdf6d8", ...setText(settings().grace), "font-family":"Centaur" }}>{settings().grace === "NUMBER" ? newGrace() : settings().grace === "PERCENTAGE" ? `${Math.round(gracePercentage())}` : ""}{ settings().grace === "PERCENTAGE" && <span class="super" style={{ "font-size": "0.5em" }}>%</span>}</p>
    </div>;
};