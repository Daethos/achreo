...
export const ACTION_ORIGIN = {
    ...
    JUMP: {
        ...
        special: "(Physical)",
        svg: "JUMP",
        talent: "Optimized: [Uncertain]. Enhanced: Doubles Jump Distance.",
    },
    PARRY: {
        name: "Parry",
    ...
    ROLL: {
        ...
        special: "(Physical)",
        svg: "ROLL",
        talent: "Optimized: Doubles Roll Distance. Enhanced: Melee Gains Extra Roll Attack, Ranged Can Shoot Projectiles.",
    },
    THRUST: {
        name: "Thrust",
    ...
    "LUCKOUT (ARBITUOUS)": {
        name: "Luckout (Arbituous)",
        description: "Convince the enemy through rhetoric to cease.",
        cooldown: `${PLAYER.COOLDOWNS.SHORT / 1000}s`,
        cost: `${PLAYER.STAMINA.LUCKOUT} Grace`,
        time: "Channel",
        special: "(Bizarre)",
        svg: "INVOKE",
        talent: "Optimized: Lowers Cooldown, Lowers Grace. Enhanced: Halves the time it takes to attempt."
    },
    "LUCKOUT (CHIOMIC)": {
        name: "Luckout (Chiomic)",
        description: "Invoke the Ancient Chiomyr, reducing the enemy to a broken mind of mockery.",
        cooldown: `${PLAYER.COOLDOWNS.SHORT / 1000}s`,
        cost: `${PLAYER.STAMINA.LUCKOUT} Grace`,
        time: "Channel",
        special: "(Bizarre)",
    ...
    "LUCKOUT (KYR'NAIC)": {
        name: "Luckout (Kyr'naic)",
        description: "Convince the enemy to acquiesce, giving their life to the Aenservaesai.",
        cooldown: `${PLAYER.COOLDOWNS.SHORT / 1000}s`,
        cost: `${PLAYER.STAMINA.LUCKOUT} Grace`,
        time: "Channel",
        special: "(Bizarre)",
    ...
    "LUCKOUT (LILOSIAN)": {
        name: "Luckout (Lilosian)",
        description: "Convince the enemy to profess their follies and willow.",
        cooldown: `${PLAYER.COOLDOWNS.SHORT / 1000}s`,
        cost: `${PLAYER.STAMINA.LUCKOUT} Grace`,
        time: "Channel",
        special: "(Bizarre)",
    ...
    "PERSUASION (ARBITUOUS)": {
        name: "Persuasion (Arbituous)",
        description: "Use knowledge of Ley Law to deter enemies from aggression.",
        cooldown: "1.5s",
    ...
    "PERSUASION (CHIOMIC)": {
        name: "Persuasion (Chiomic)",
        description: "Cause bouts of confusion and disorientation in the enemy.",
        cooldown: "1.5s",
        cost: `${PLAYER.STAMINA.PERSUASION} Stamina`,
        time: "Channel",
        special: "(Dialog)",
    ...
    "PERSUASION (KYR'NAIC)": {
        name: "Persuasion (Kyr'naic)",
        description: "Cause the enemy to embrace the hush and tendril.",
        cooldown: "1.5s",
        cost: `${PLAYER.STAMINA.PERSUASION} Stamina`,
        time: "Channel",
        special: "(Dialog)",
    ...
    "PERSUASION (ILIAN)": {
        name: "Persuasion (Ilian)",
        description: "The weight of your words can sway the minds of others.",
        cooldown: "1.5s",
        cost: `${PLAYER.STAMINA.PERSUASION} Stamina`,
        time: "Channel",
        special: "(Dialog)",
    ...
    "PERSUASION (LILOSIAN)": {
        name: "Persuasion (Lilosian)",
        description: "Speak to your enemy's faith and stay their hand.",
        cooldown: "1.5s",
        cost: `${PLAYER.STAMINA.PERSUASION} Stamina`,
        time: "Channel",
        special: "(Dialog)",
