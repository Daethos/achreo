...
export const ENEMY_ENEMIES = {
    ...
    "Fyers Occultist": [AHNARE_APOSTLE, DAETHIC_INQUISITOR, DAETHIC_KNIGHT, ILIRE_OCCULTIST, MAIER_OCCULTIST, QUOREITE_OCCULTIST, OLD_LIIVI_OCCULTIST],
    "Ilire Occultist": [AHNARE_APOSTLE, DAETHIC_INQUISITOR, DAETHIC_KNIGHT, FYERS_OCCULTIST, MAIER_OCCULTIST, MAVROSIN_OCCULTIST, QUOREITE_OCCULTIST, OLD_LIIVI_OCCULTIST],
    ...
    "Northren Wanderer": [ACHREON_DRUID, CAMBIREN_DRUID, MARAUDER, MAVROSIN_OCCULTIST, SOUTHRON_WANDERER, KINGSMAN, SOVERAIN_BLOOD_CLOAK],
    ...
    "Soverain Blood Cloak": [ANASHTRE, DAETHIC_INQUISITOR, DAETHIC_KNIGHT, LIIVI_LEGIONNAIRE, KINGSMAN, NORTHREN_WANDERER],
