...
import { ABSORB, ACHIRE, ARC, ASTRAVE, BLINK, CHARM, CHIOMIC, CHIOMISM, CONFUSE, DESPERATION, DISEASE, DISPEL, ENVELOP, FEAR, FREEZE, FROST, FYERUS, HEALING, HOOK, HOWL, ILIRECH, KYNISOS, KYRISIAN, KYRNAICISM, LEAP, LIGHTNING, LIKYR, MAIERETH, MALICE, MARK, MENACE, MEND, MODERATE, MULTIFARIOUS, MYSTIFY, NETHERSWAP, PARALYZE, POLYMORPH, PROTECT, PURSUIT, QUOR, RECALL, RECONSTITUTE, RECOVER, REIN, RENEWAL, ROOT, RUSH, SACRIFICE, SCREAM, SHADOW, SHIELD, SHIMMER, SHIRK, SLOW, SNARE, SPECIAL, SPRINT, STORM, SUTURE, TETHER, WARD, WRITHE } from "./abilities";
...
export const QUEST_TEMPLATES = [
    {
        ...
        reward: [ACHIRE, ARC, CHIOMISM, FROST, HOOK, ILIRECH, KYRNAICISM, KYRISIAN, LEAP, LIGHTNING, LIKYR, MAIERETH, PURSUIT, QUOR, RUSH, SACRIFICE, SHADOW, SHIMMER, SPRINT, STORM, SUTURE, TETHER]
    }, {
