...
export const SupernaturalEntityLore: SupernaturalEntity = {
    "Ahn'are": `"These creatures are mighty, standing as tall as a man, but fare a bit lighter, making up for it tenfold in their gracious ability to fly on wings spanning twice their height. Legend speaks of Ahn've, a capricious Ancient, never comfortable with her choice of setting, weaving a spell to tether a unique bird to that land with a worthy sacrifice of an adherent follower, so as to keep her company. \n 
        Depending on the breed it took after, these creatures could soar far and above, out of eye shot of an observer, and come swooping down at terrifying speeds, capable of snatching unsuspecting folk from the land, never to be seen again. It is said there is a distinction for every one of the lands in which they inhabit, and for this reason the various leaders have made it their unofficial moniker to breed the pure variants for their carrier birds, and are cared for more deeply and thoroughly thanthe rest. \n 
        Oral tradition has given way to the writing of various tomes, books, and scrolls on the subject, witn most conjecture believing in their existence now or once before, as said writings keep valuable information on the instructions to tend for the birds, in addition to quirks, breeding practices, behavior, dietary preferences, and preferred places of habitation. \n 
        The Ahn'are themself, though, seem to take after more pernicious, human-like behaviors, and are said to be full of tricky and luring with their songs and voice--Shrygei believed to having gifted them with such beauty they could not help but sing such sweet music, an affectation for his love of Ahn've, keeping in tight flocks and picking off prey when necessary to feed themselves and their children, or so the tales say. \n 
        Evidence has been noted of larger nesting grounds that could house such creatures of size they're purported to be, though fewer still have any proof of their legitimacy, sans witness reports and 'honest' accounts. Invariably, it's hard to know which features are the most prominent between them, as you would to better to spy the bird in question of a specific province, and extend in your ming what he creature would look like, overlaying a human specimen."`,
    
    Cerchre: `"These beasts are imagined to be some splicing of a stag and a man, managing to stay upright and bring their height well past that of a giant man, anywhere from eight to ten feet depending on the account, and that is without consideration of its antlers. \n 
    ...
    Cragore: `"As the tale goes, these are strong, brutish creatures that live among the rocky hills and mountains, heard to reside on the ranged separating the Achreon, now Daethic Kingdom from the South, and around the spine of the Astralands. \n
    ...
    Dwarves: `"This is not to be confused wiht the uncommon, unfortunate, unforgiving small fok you may see plague and curse a family. These folk are cut from something harder than flesh and bone. They look heavy, of squat stone, carved into being and given achre from one of the more creative Ancients, Se'dyro. \n
    ...
    Gatshyr: `"Human-like cat creatures with reversed palms being their most notable trait after the fur, color, and head of a feline. They come in different breeds depending on the land, with some looking like that of lions, lynxes, jaguars, and even tigers in the Isles. \n
    ...
    "Ma'ier": `"The most human-like of all these entities, their appearance ranges as much as the average human differs fro manother. They can be short, bald, and take, to tall, lithe, and handsome. Men and women have been said to possess ma'ierec qualities or outright be one. \n
    ...
    Morath: `"Possibly the most fearsome of these abominations, one must be thankful that these appear to be of little truth--yet further still, its pure counterpart is dangerous enough to give pause all the same. \n
    ...
    Quoros: `"Often these horrific monsters are characterized as being similar in vein, whether through witness accounts or descriptions in oral tradition, as bearing likeness to the Cragore, or Tshios. \n
    ...
    Tshios: `"Taller, leaner creatures not without a liveliness and strength that live among the Boreal, Temperate, Tropical, and subtropical forests around the lands that sustain the foliage, such as the Eye in the Daethic Kingdom/Soverains, the Astralands, the Firelands, Sedyrus, and the Alluring Isles. \n
    ...
    "Ky'myr": `"Legends speak of it sability to thwart the glowering and overwhelming effects of, interestingly, the death of Lilos and Kyr'na, fracturing its caer and disposing of it in a bejeweled object or personal heirloom, which keeps the creature in a state of permanence for as long as the item in question persists. \n
        ...
        For all the woe that besieges such a foul creature, they are not without the inherent advantages over the living: firstly being its immortality, in a seeming balance that nature cannot upend. due to this, they have a long standing association with Vielo, and have inclination toward the use of Insight, and Parashifting, as demonstrated previously with their use of split caer. \n
    ...
    "Rana'vas": `"Almost nothing is known of these frog beasts, whether they are some variant of its pure cousin, or a mendind of them into that of man, and much information that does exist is extrapolated from the writing of other human-like creatures. \m
    ...
    Shamanic: `"Dire animals that are inhabited with the mind of some gifted, spoken of as shattering, more specficially its shifting variant. In this form, one has the requisite abilites of the animal, but carry with them a human's capacity for cleverness, creativity, and malice. \n
...
export const SupernaturalPhenomenaLore: SupernaturalPhenomena = {
    Shifting: `"A form of shattering your one's caer. Capable of sailing through the skies with your achre and caeren, a form of projection of your form without substance. Can use this new recruitment of senses to collect and/or transport information, hunt, main, and kill, or perhaps something more sinsister, staging. \n
    ...
    Charm: `"Capable of casting with as little effort as a gaze, whisper, or glancing touch, effectively influenceing said individual for a time, depending on the application of the charm itself. \n
    ...
    Insight: `"The power of Insight takes on quite a few qualities, namely those skewed toward mental ability. There is more written on these ideas of the expanded mind than aany other subject on the matter of phenomena of another nature. That does not necessarily lend itself toward hard evnidence on the matter, though plenty of ocnjecture and belief in certain events being augmented by such. \n
