...
export const SupernaturalEntityLore: SupernaturalEntity = {
    Hybrida: {
        ...
        Cragore: `The Cragore \n
            ...
            "Different weathers along the mountain ranges precipitate different tribes and within them, various beliefs and interwarring. It is not certain if they believe in an Ancient and still pratice adherence toward the old, but if one were to bet, it would be easy to imagine prayers being sent to Kyn'gi, Se'vas, and Tshaer. \n
        ...
        "Re'vas": `The Re'vas \n
            ...
            "It isn't in keeping with understanding what manifests itself after death, and the idea that the dead can continue living is considered shameful and afflicts on a curse on the remaining and subsequent lineage of the Re'vas. Due to this, it can be imagined why some are abhorrent to the notion that these creatures exist at all. \n
            "There is another table to be told about the Re'vas, and that is one that speaks directly on the belief of the elder Ancients, and Daethos. In it, certain tome's have spoken of a pact, older than written history, that culminated in the steadfast opposition to the rise of Daethos. \n
    ...
    Specificus: {
        ...
        Draochre: `The Draochre \n
            ...
            "It is not certain where these myths originate, some saying they were awakened during the War of the Ancients to protect nature from the ensuing chaos and destruction that plagued the realm, warding off the armoes that marched, putting Ancient against Ancient. \n
...
export const whispers: Whispers = { // Localized Provincial Lore
    ...
    Draochre: {
        ...
        worship: `"Multiple shrines were built throughout the land (including man-shaped braziers that entombed a human sacrifice) in homage, currying the Ancient’s favor, keeping the surrounding areas undisturbed as recompense for the resources used in building said monuments, marked as places of worship, though scholars are unsure if this was the best measure to showcase their faithfulness to Achreo or Cambire, renowned to be absent and capricious Ancients. These forms of worship even went so far as to take place in human sacrifice. The Dachreon of Druids clamored to his favor as well, as most orations and written scrolls tend to adhere to this perception. \n
            "The reckless abandon of any gifts offered never deterred those who remained vigilant in their worship and endless attempts of appeasement to make their lives better for it. Achreo and Cambire are associated with Shattering, and lead some to speculate on the abilities of some Druids henceforth on their proclivities toward the supernatural phenomena. In addition to Shattering, it’s also believed that Druids were capable of Scrying (Divination), reading the flight patterns of birds, the arrangement of the stars in the night sky, as well as the formations of branches in a Snag, the bones found of a decomposed animal, the twitches and convulsions of a sacrificial human to the Ancients, so on and so forth. \n
...
export const worldLore: World_Events = { // Old World Lore of each Province
    ...
    Sundering: `The Sundering \n
        ...
        "One issue most peculiar of all is the flux of time that seems to have been the belief held for why such accounts of the war, and timelines don’t appear to match. This may have in some part been due to the perishing of Kyr’na, though it is said she had given herself to the restoration of the realm during the Last Rites (Along with Lilos), and that her death may have inflicted a shift with the occurrences, similar to the Sundering of the realm. Whatever happened, it does appear to be a mystery insofar as the motivations and first upheaval of the War, though it seems that it’s not uncommon given the nature of the Ancients, and by extension us. \n
