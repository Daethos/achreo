export const TIPS = [
    ...
    "Magic projectiles leave behind an aoe that can damage anyone, even you!",
    "Enemies will always have a small chance to contemplate and invoke a caerenic instinct.",
    "When underground, take care to aim your projectiles, as they may collide with the walls.",
