...
export default function TutorialOverlay({ id, tutorial, show, setShow }: { id: string; tutorial: Accessor<string>; show: Accessor<boolean>; setShow: Setter<boolean>; }) {
    ...
    return (
        <div class='modal' style={{ background: 'rgba(0, 0, 0, 0.75)', 'z-index': 1000 }}>
            { tutorial() === 'boot' && <div>
                <p class='cornerTL gold highlight' style={{ left: '0', top: '5em', 'font-weight': 700, border: '0.1em solid #fdf6d8' }}>
                ...
                <p class='cornerTR gold highlight' style={{ right: '0', top: '3.5em', 'font-weight': 700, border: '0.1em solid #fdf6d8' }}>
                ...
                <p class='cornerBL gold highlight' style={{ bottom: '0', left: '1em', 'font-weight': 700, border: '0.1em solid #fdf6d8' }}>
            ...
            { tutorial() === 'death' && <div>
                ...
                <p class='cornerTR gold highlight' style={{ top: '5em', 'font-weight': 700, border: '0.1em solid #fdf6d8' }}>
            ...
            { tutorial() === 'character' && <div>
                <p class='cornerTR gold highlight' style={{ right: '20%', 'font-weight': 700, border: '0.1em solid #fdf6d8' }}>
                ...
                <p class='cornerBR gold highlight' style={{ bottom: '10%', right: '0', 'font-weight': 700, border: '0.1em solid #fdf6d8' }} onClick={() => exitTutorial()}>
            ...
            { tutorial() === 'inventory' && <div>
                <p class='cornerTR gold highlight' style={{ right: '10%', 'font-weight': 700, border: '0.1em solid #fdf6d8' }}>
                ...
                <p class='cornerBR gold highlight' style={{ bottom: '10%', 'font-weight': 700, border: '0.1em solid #fdf6d8' }} onClick={() => exitTutorial()}>
            ...
            { tutorial() === 'loot' && <div style={{ 'z-index': 1000 }}>
                <p class='superCenter gold highlight' style={{ top: '35%', 'font-weight': 700, border: '0.1em solid #fdf6d8' }}>
            ...
            { tutorial() === 'settings' && <div>
                <p class='cornerTL gold highlight' style={{ 'font-weight': 700, border: '0.1em solid #fdf6d8' }}>
                ...
                <p class='cornerTL gold highlight' style={{ left: '50%', top: '7.5%', 'font-weight': 700, border: '0.1em solid #fdf6d8', transform: 'translateX(-50%)' }}> 
                ...
                <p class='cornerBR gold highlight' style={{ bottom: '10%', right: '3%', 'font-weight': 700, border: '0.1em solid #fdf6d8' }}>
                    {arrows.up} <br /> <br />
            ...
            { tutorial() === 'views' && <div>
                <p class='cornerTL gold highlight' style={{ left: '12.5%', 'font-weight': 700, border: '0.1em solid #fdf6d8' }}>
                ...
                <p class='cornerTR gold highlight' style={{ right: '5%', 'font-weight': 700, border: '0.1em solid #fdf6d8' }}>
                    Click here to exit views {arrows.right} <br />
                    <span class='super' style={{ color: '#fdf6d8' }}>[Your postiion in these 'views' is saved.]</span>
                </p>
                <p class='cornerBL gold highlight' style={{ bottom: '0', left: '3%', 'font-weight': 700, border: '0.1em solid #fdf6d8' }}>
                    {arrows.up} <br /> 
